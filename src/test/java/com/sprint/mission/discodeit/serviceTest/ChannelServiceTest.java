...
public class ChannelServiceTest {
  ...
  class CreateTest {
    ...
    void create_PublicChannel_ChannelSuccess() {
      ...
      given(channelMapper.toDto(any(Channel.class), anyList(), any(Instant.class))).willReturn(
          fakeDto);
  ...
  class FindByUserIdTest {
    ...
    void find_whenAllByUserId_ChannelSuccess() {
      ...
      ChannelDto fakeDto = new ChannelDto(
          ...
          null);
      given(messageRepository.findLastMessageAtByChannelId(any())).willReturn(Optional.empty());
      given(channelMapper.toDto(eq(channel), anyList(), any(Instant.class))).willReturn(fakeDto);
