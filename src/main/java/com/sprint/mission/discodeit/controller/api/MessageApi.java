...
public interface MessageApi {
  ...
  ResponseEntity<PageResponse<MessageDto>> findAllByChannelId(
      ...
      @Parameter(description = "페이징 커서 정보") @RequestParam Instant cursor,
      @Parameter(description = "페이징 정보", example = "{\"size\": 50, \"sort\": \"createdAt,desc\"}") @PageableDefault Pageable pageable
  );
}
