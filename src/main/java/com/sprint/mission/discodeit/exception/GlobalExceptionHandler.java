...
public class GlobalExceptionHandler {
  ...
  private HttpStatus determineHttpStatus(DiscodeitException exception) {
    ...
    return switch (errorCode) {
      ...
      case INVALID_USER_CREDENTIALS, AUTHENTICATION_FAILED -> HttpStatus.UNAUTHORIZED;
      case PRIVATE_CHANNEL_UPDATE, INVALID_REQUEST -> HttpStatus.BAD_REQUEST;
      case INTERNAL_SERVER_ERROR, TOKEN_GENERATION_FAILED -> HttpStatus.INTERNAL_SERVER_ERROR;
      case ACCESS_DENIED, Notification_ACCESS_DENIED -> HttpStatus.FORBIDDEN;
    };
  }
}
